...
var que = []; //FIFO
var samples = [];
var next_sample = 0; //Sequence
var next_sample_str = '36'; //Sequence
var payload = ''; //MSG
var THRESHOLD_SIZE = 9;
var COUNT = '3'; //NUM_PACKET
...
function HTTPS_Request(){
    ...
    //var url = 'https://smstestbed.nist.gov/vds/Mazak01/sample?interval=0&heartbeat=1000';
    //var url = 'http://192.168.0.60:5000/sample?path=//Axes//DataItem&from='+next_sample_str+'&count='+COUNT;
    var url = 'http://192.168.0.60:5000/sample?interval=0&heartbeat=1000';
    console.log(url);
    data = '';
